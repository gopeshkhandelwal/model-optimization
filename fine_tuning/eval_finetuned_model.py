...
class ModelEvaluator:
    ...
    def evaluate(self, dataset, max_examples: int = 100) -> Tuple[Dict, List[str], List[str]]:
...
def print_comparison(base_results: Dict, ft_results: Dict, 
                    ...
                    references: List[str], model_names: Tuple[str, str]):
...
def main():
    ...
    base_results, base_preds, base_refs = base_evaluator.evaluate(eval_dataset, MAX_EXAMPLES)
    
    # Evaluate fine-tuned model
    print("Evaluating fine-tuned model...")
    ft_results, ft_preds, ft_refs = ft_evaluator.evaluate(eval_dataset, MAX_EXAMPLES)
